export const homePageDefaults = {
  ...
  leadership: {
    ...
    items: [
      {
        title: "Preeti Bhatnagar",
        role: "Partner - CIA(US), CPA(US)",
        href: "/preeti-bhatnagar",
        ...
        text: "Strategic finance and tax professional with 19+ years of experience across audit, transfer pricing, corporate tax, and international taxation.",
      },
      {
        title: "Sagar Bajaj",
        ...
        text: "International tax and finance professional with experience across the US, UK, Australia, Canada, India, and UAE.",
      },
      {
        title: "Deepak Tulsiyan",
        role: "Partner - CPA(USA), CA (India), LLB",
        href: "/deepak-tulsiyan",
        ...
        text: "Finance and advisory professional with 30+ years of experience across accounting, taxation, audit, and strategic business advisory.",
      },
    ],
  },
  who: {
